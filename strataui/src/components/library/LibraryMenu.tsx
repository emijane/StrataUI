...
export default function LibraryMenu({ mobileOpen, onClose }: Props) {
    ...
    return (
        <aside
            className={`
                bg-white border-r border-gray-200 px-4 py-5 w-full overflow-y-auto
                ${mobileOpen
                    ? 'block fixed top-[160px] left-0 right-0 z-[100] border-b max-h-[calc(100vh-160px)]' // <-- z-[100]
                    : 'hidden'}
                lg:block
                lg:sticky lg:top-[0px]
                lg:max-h-[100vh]
                lg:w-72 lg:shrink-0
                lg:shadow-none lg:border-b-0
            `}
            aria-label="Sidebar"
        >
            <div className="px-3">
